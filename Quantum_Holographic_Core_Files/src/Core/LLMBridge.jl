...
function intelligence_loop(client::LLMClient, initial_prompt::String; iterations::Int=3)::Vector{Tuple{String, Vector{Float64}}}
    ...
    for i in 1:iterations
        println("ðŸ”„ Intelligence Loop Iteration $i/$iterations")
        ...
        if response.success
            ...
            println("   âŒ Error: $(response.error)")
...
function demo()
    println("ðŸŒŒ LLMBridge.jl Demo")
    println("=" ^ 50)
