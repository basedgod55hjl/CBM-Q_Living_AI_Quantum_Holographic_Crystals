...
# ðŸŒŒ CBM-Q: Semantic Network & Knowledge Graph
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
function teach!(kg::KnowledgeGraph, teaching::String)
    ...
    elseif occursin("=", teaching)
        ...
        return "âŒ Invalid format. Use: conceptâ†’relation=explanation or concept=response1|response2"
    end
end
...
function demo()
    println("ðŸ§  SEMANTIC NETWORK DEMO")
    println("=" ^ 50)
