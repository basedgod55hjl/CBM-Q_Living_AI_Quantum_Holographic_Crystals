...
function launch_studio(env::StudioEnvironment; gui::Bool=true)
    ...
    println("â•‘  ðŸŒŒ CBM STUDIO: Sovereign IDE & Monitoring Dashboard         â•‘")
    println("â•‘  Session: $(env.session_id)                          â•‘")
    println("â•šâ•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•")
    println("   Status: Initializing Studio Infrastructure...")
    
    if gui
        println("   ðŸŽ¨ Launching Sovereign IDE Window (Blink + WaterLily)...")
        try
...
function open_notebook(; name::String="CBM_Manifold_Exploration.ipynb")
    if _HAS_IJULIA
        println("ðŸ“– Opening CBM-Q Notebook: $name")
...
function manifest_console(env::StudioEnvironment)
    println("ðŸ“Ÿ CBM-Q Manifold Console Manifested.")
...
function Base.show(io::IO, env::StudioEnvironment)
    ...
    println(io, "  Status:  $(env.active_manifold ? "ðŸŒŒ Active" : "ðŸ’¤ Standby")")
    println(io, ")")
end
...
function demo()
    println("ðŸŒŒ CBMStudio.jl Demo")
    println("=" ^ 50)
