...
println("=" ^ 70)
println("ðŸŒŒ CBM-Q Fine-Tune & Chat Pipeline - Full System Test")
println("=" ^ 70)

# Test 1: Discover GGUF Models
println("\n[1/5] ðŸ” Scanning for GGUF models on system...")
...
println("\n[2/5] ðŸ“ Generating CBM-Q training data...")
...
println("\n[4/5] ðŸ”„ Generating GGUF conversion script...")
...
println("\n[5/5] ðŸ’¬ Testing Chat Session Initialization...")
