...
# ðŸŒŒ CBM-Q: Official Native Julia Launcher
# â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•â•
...
println("ðŸš€ Initializing CBM-Q Environment...")
Pkg.activate("CBM.jl")

# Check if dependencies are installed, if not, instantiate
if !isfile("CBM.jl/Manifest.toml")
    println("ðŸ“¦ First-time setup detected. Instantiating project ecosystem...")
    Pkg.instantiate()
end
...
# 3. Manifest Studio
println("\nðŸŽ¨ Manifesting Studio Dashboard...")
...
if length(ARGS) > 0 && ARGS[1] == "--demo"
    ...
    welcome()
    println("\n" * "â•" ^ 65)
    println("ðŸŒŸ SOVEREIGN REPL READY")
    println("â•" ^ 65)
